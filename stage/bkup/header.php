...
<link rel="shortcut icon" type="image/x-icon" href="i<?php echo get_stylesheet_directory_uri(); ?>/mages/favicon.ico"/>
...
<link rel="icon" type="image/vnd.microsoft.icon" sizes="150x150" href="<?php echo get_stylesheet_directory_uri(); ?>/images/mstile-150x150.png"/>

<link rel="icon" type="image/png" sizes="192x192" href="<?php echo get_stylesheet_directory_uri(); ?>/images/android-chrome-192x192.png"/>

<link rel="icon" type="image/png" sizes="192x192" href="<?php echo get_stylesheet_directory_uri(); ?>/images/android-chrome-512x512.png"/>
